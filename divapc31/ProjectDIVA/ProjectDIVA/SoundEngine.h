...
public:
	...
	virtual DWORD ReadMusic(string filename, bool bTempo=false){return 0;}
...
public:
	...
	HSAMPLE ReadMusic(string filename, bool bTempo=false);
...
public:
	...
	DWORD ReadMusic(string filename, bool bTempo=false);
	...
	float GetPitch(int channel_id=0);
};
