...
class GameUI
{
	...
	ImageResource *rhythm_logo_rc, *hp_gauge_rc, *hp_rhyme_rc, *hp_UPs_rc, *hp_ExQn_rc, *hp_Ex_rc, *combo_gauge_rc;
...
public:
	...
	void ChangePlaySpeed(double deltaRatio);
	void ChangePitch(double val);
	void ChangeTempo(double val);
