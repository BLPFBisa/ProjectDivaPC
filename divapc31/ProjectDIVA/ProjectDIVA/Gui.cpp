...
void NormalButton::Draw(int Basex, int Basey)
{
	if(visible)
	{
		...
		graphEngine.SetFont(StringTable(56).c_str(),font.ftSize,font.ftItalic,font.ftWeight);
...
void ScoreMenu::Draw()
{
	...
	numberMana.Draw(coolcntN,MakeRect(141,87,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);
	numberMana.Draw(finecntN,MakeRect(141,105,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);
	numberMana.Draw(safecntN,MakeRect(141,123,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);
	numberMana.Draw(sadcntN,MakeRect(141,141,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);
	numberMana.Draw(worstcntN,MakeRect(141,159,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);
	numberMana.Draw(combocntN,MakeRect(141,177,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);
	numberMana.Draw(chancetimecntN,MakeRect(141,195,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),0);

	numberMana.Draw(scorecntN,MakeRect(141,223,99,15),NumberStyle::SCORE, NumberDwFlags::DWFLAG_RIGHT,D3DCOLOR_ARGB(255,255,255,255),2,7);
