...
namespace base
{
	...
	int MsgLoop()
	{
		...
		while(msg.message != WM_QUIT)
		{
			...
			{
				// Û±ÅEœ∂Ø¥∞ø⁄ª¨≥ˆ¥∞ø⁄Õ‚µƒ¥¶¿ÅE
				if(bNcLButtonDown)
				{
					::GetCursorPos(&MouseCurPos); // Û±ÅE¥œ¬ªÒ»°µ±«∞Œª÷√£¨“‘±„»°≥ˆœ÷∂‘Œª÷√
	...
	LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
	{
		...
		switch( msg )
		{
		//œ¬√Ê «πÿ”⁄Õœ∂Ø¥∞ø⁄±‹√‚œ˚œ¢∂™ ßµƒ¥¶¿ÅE------------------------------------------------------------------------------------
		case WM_NCLBUTTONUP: // Û±ÅEß∆ ±±ÅE«£¨±˙Êæ≤ª‘ŸÕœ∂Ø£¨±ÅE«…Ë÷√Œ™false
		bNcLButtonDown = false;
		return DefWindowProc(hwnd,msg,wParam,lParam);
		case WM_NCRBUTTONDOWN://‘⁄±ÅE‚¿∏…œµ„ª˜”“ºÅEª◊ˆ¥¶¿˙ø¨æÕ «≤ª“™µØ≥ˆœµÕ≥≤Àµ•
		return 0;
		case WM_NCMOUSELEAVE:// Û±ÅEˆ¡À±ÅE‚¿∏µƒ ±∫Ú±ÅE«“≤“™…Ë÷√Œ™false£¨±‹√‚ Û±ÅEﬁ∑®∂®Œª
		bNcLButtonDown = false;
		return DefWindowProc(hwnd,msg,wParam,lParam);
		case WM_SYSCOMMAND:
		switch( wParam & 0xfff0 )
		{
		///////////////’‚¿ÅE±Ω”∑µªÿ£¨±‹√‚Ω¯»ÅE˚œ¢—≠ª∑≤ª≥ˆ¿¥£¨ π”Œœ∑freese////////////////////
		//µ± Û±ÅE⁄±ÅE‚¿∏…œ∞¥◊°≤ª∑≈ ±£¨œµÕ≥ª·∑¢ÀÕWM_SYSCOMMANDœ˚œ¢£¨µ±DefWindowProc
		// ’µΩSC_MOVE∫Û£¨ª·∑¢ÀÕWM_ENTERSIZEMOVE£¨’‚∏ˆ ±∫Ú’˚∏ˆœ˚œ¢—≠ª∑æÕª·Õ£÷π£¨÷±µΩ
		//DefWindowProc¥¶¿˙ÈÅE…∑µªÿ£¨À˘“‘’‚∏ˆœ˚œ¢≤ªƒ‹Ωª∏¯œµÕ≥¥¶¿˙ø¨÷±Ω”∑µªÿ
		//SC_KEYMENUœ˚œ¢ «∞¥øÅE›ºÅEƒ ±∫Ú≤˙…˙µƒœµÕ≥≤Àµ•£¨’‚ ±∫Úœ˚œ¢—≠ª∑“≤ «Õ£÷πµƒ£¨÷±µΩ
		//DefWindowProc¥¶¿˙ÈÅE…∑µªÿ
		//SC_MOUSEMENUœ˚œ¢ « Û±ÅEÛºÅE„ª˜◊Û…œΩ«–°Õº±ÅE«≤˙…˙µƒœµÕ≥≤Àµ•£¨Õ¨…œ
		case SC_MOVE:  //’‚¿ÅE«∂‡≥ˆ¿¥µƒ
		::GetCursorPos(&MouseCurPos); // Û±ÅE¥œ¬ªÒ»°µ±«∞Œª÷√£¨“‘±„»°≥ˆœ÷∂‘Œª÷√
		...
		//Ω‚æˆ‘⁄æ≠µ‰¥∞ø⁄(Windows Classic Style)ƒ£ Ωœ¬£¨ ’≤ªµΩWM_NCMOUSELEAVEµƒŒ ÃÅE
		if(bNcLButtonDown)
		{
		...
		////////////’‚¿ÅE˘æ› Û±ÅEƒœ‡∂‘Œª÷√…Ë÷√¥∞ø⁄Œª÷√///////////////////////////////////////////////////////
		//’‚¿ÅE«∏˘æ› Û±ÅE˚œ¢ƒ£ƒ‚¥∞ø⁄“∆∂Øµƒπ˝≥Ã
		if(bNcLButtonDown)
		{
		...
		case WM_SETFOCUS:
			if(base::Device&&base::Device->TestCooperativeLevel()==D3DERR_DEVICENOTRESET)
				base::Device->Reset(NULL);
			break;
