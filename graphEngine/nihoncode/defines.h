...
public:
	...
	unsigned int GameKeyUp, GameKeyDown, GameKeyLeft, GameKeyRight, 
				GameKeyTriangle, GameKeyCross, GameKeyRectangle, GameKeyCircle;
	...
	int winSizeType; //1-480*272 2-720*408 3-960*544 4-◊‘∂®“ÅE

	void ChangeGameKeyType(int type);
	void ChangeSndVolume(int volume);
	void ChangeWindowSize(int sizeType);
